<style>
/* Estilos modernos y premium para el catálogo del Home */
...
.product-title {
    ...
    overflow: hidden;
    height: 48px; /* Ensure 2 lines */
}
.product-title:hover {
    color: #007bff;
}
.product-rating {
    color: #f39c12; /* Color estrella amarillo */
    font-size: 16px;
    margin-bottom: 8px;
    display: flex;
    align-items: center;
...
<div class="home-catalog-container">
    ...
    <h1 class="home-section-title"><i class="fas fa-fire"></i> Ofertas del Día</h1>
    ...
    <h1 class="home-section-title" style="background: #2c3e50;"><i class="fas fa-star"></i> Destacados</h1>
    <div class="products-grid">
        ...
        <div class="product-card" onclick="window.location.href='index.php?page=Products_ProductoController&action=verDetalle&id={{productId}}'">
            ...
            <div class="product-rating">
                &#9733;&#9733;&#9733;&#9733;&#9733; <span class="rating-count">(+280 Comentarios)</span>
            </div>
    ...
    <h1 class="home-section-title" style="background: #e67e22;"><i class="fas fa-bolt"></i> Novedades</h1>
    <div class="products-grid">
        {{foreach productsNew}}
        <div class="product-card" onclick="window.location.href='index.php?page=Products_ProductoController&action=verDetalle&id={{productId}}'">
            <div class="product-img-wrapper">
            ...
            <div class="product-rating">
                &#9733;&#9733;&#9733;&#9733;&#9734; <span class="rating-count">(+45 Comentarios / Nuevo)</span>
            </div>
